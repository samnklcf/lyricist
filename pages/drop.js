      ...
      ==================================== */}
            <section className="un-page-components">
              <div className="un-title-default">
                <div className="text">
                  <h2>Dropdowns</h2>
                  <p>Default examples of Dropdowns</p>
                </div>
              </div>
              <div className="content-comp p-0">
                <div className="space-items" />
                <div className="bg-white padding-20 d-flex flex-wrap gap-2 blockOne">
                  <div className="dropdown">
                    <button
                      className="btn rounded-10 size-14 padding-y-8 bg-primary text-white dropdown-toggle"
                      type="button"
                  ...
                  <div className="dropdown">
                    <button
                      className="btn rounded-10 size-14 padding-y-8 bg-secondary text-white dropdown-toggle"
                      type="button"
                      id="dropdownMenuButton1"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                ...
                <div className="space-items" />
                <div className="bg-white padding-20 blockTwo">
                  <p>
                    Add Class <code>drop-full</code> to dropdown and{" "}
                    <code>w-100</code> to dropdown-toggle
                  </p>
                  <div className="dropdown drop-full">
                    <button
                      className="btn rounded-10 w-100 size-14 padding-y-8 bg-primary text-white dropdown-toggle"
                      type="button"
                      id="dropdownMenuButton1"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                ...
                <div className="space-items" />
                <div className="bg-white padding-20 d-flex flex-wrap gap-2 blockThree">
                  <p>
                    Add Class <code>shadow-small</code> to dropdown-menu.
                  </p>
                  <div className="dropdown">
                    <button
                      className="btn rounded-10 w-100 size-14 padding-y-8 bg-primary text-white dropdown-toggle"
                    ...
                    <ul
                      className="dropdown-menu shadow-small"
                      aria-labelledby="dropdownMenuButton1"
                    >
                      <li>
                        <a className="dropdown-item" href="#">
                ...
                <div className="space-items" />
                <div className="bg-white padding-20 blockFour">
                  <p>
                    Add Class <code>dropend</code> to dropdown and{" "}
                    <code>drop-more</code> to dropdown.
                  </p>
                  <div className="dropdown dropend drop-more">
                    <button
                      className="btn rounded-pill border dropdown-toggle"
                      type="button"
                      id="dropdownMenuButton1"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                ...
                <div className="space-items" />
                <div className="bg-white padding-20 blockFive">
                  <p>
                    Add Class <code>dropstart</code> to dropdown and{" "}
                    <code>drop-more</code> to dropdown.
                  </p>
                  <div className="d-flex justify-content-end">
                    <div className="dropdown dropstart drop-more">
                      <button
                        className="btn rounded-pill border dropdown-toggle"
                        type="button"
                        id="dropdownMenuButton1"
                ...
                <div className="space-items" />
                <div className="bg-white padding-20 blockSix">
                  <p>
                    Add Class <code>dropend</code> to dropdown.
                  </p>
                ...
                <div className="space-items" />
                <div className="bg-white padding-20 blockSeven">
                  <p>
                    Add Class <code>dropstart</code> to dropdown.
                  </p>
                  <div className="d-flex justify-content-end">
