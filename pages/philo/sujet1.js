                ...
                <div className="padding-20 form-edit-profile bg-white">
                  <form className="form-group" onSubmit={FormSub}>
                    ...
                    <input
                      ...
                      placeholder="e E. Husserl : « la théorie est désormais inséparable des
                      finalités opératoires »"
                      required
                      ref={theme}
                    />
                    <br />
                    <label>Context (Facultatif)</label>
                    <input
                      type="text"
                      className="form-control"
                      placeholder="Il est admis que la science se détache de toutes fins
                      pratiques.
                      "
                    ...
                    <div className="content">
                      ...
                      >
                        ...
                        <option
                          value={
                            "Je veux aussi des citations d'auteur AFRICAIN"
                          }
                        >
                          OUI
                        </option>
