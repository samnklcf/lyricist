  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Géographie" />
...
START LODAER PAGE
    ==================================== */}
      ...
      ==================================== */}
            ...
            <PageTitle title="Géographie" description="Choisissez l'un des types" />
            <Galerie>
              {matiere.map((elements) => {
                return (
                  <Link
                    href={`geo/${elements.lien}`}
                    className="item-sm-card-NFTs"
                  >
                    <div className="cover-image">
                      <img
                        className="big-image"
                        src="images/other/geo.jpg"
                        alt=""
                      />
