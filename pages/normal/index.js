...
export default function Home() {
  // ----------------partie des states--------------
  const [sortie, setSortie] = useState("Veillez cliquez sur le bouton GENERER");
  ...
  const FormSub = (e) => {
    ...
    //     `,
        theme: `
        Écris-moi une chanson ${langue.current.value.toLowerCase()} sur le thème de "${theme.current.value}" qui évoque une émotion de ${emotion.current.value.toLowerCase()}. Imagine ${couplet.current.value} couplet(s) captivant(s) et ${rime.current.value === "Avec des rîmes" ? "enchanteur(s)" : "impactant(s)"}.
  ...
  return (
    <>
      <Head>
        <title>Ecrire une chanson</title>
                  ...
                  <form className="form-group" onSubmit={FormSub}>
                    ...
                    <div className="content">
                          ...
                          <select
                            ...
                            ref={emotion}
                          >
                            <option value={"Joie et Bonheur "}>Joie et Bonheur </option>
                            <option value={"Tristesse et Mélancolie "}>Tristesse et Mélancolie </option>
                            <option value={"Passion et Amour  "}>Passion et Amour </option>
                            <option value={"Détermination et Empowerment : "}>Détermination et Empowerment : </option>
                            <option value={"Apaisement et Sérénité "}>Apaisement et Sérénité</option>
                            <option value={"Réflexion et Contemplation "}>Réflexion et Contemplation </option>
                            <option value={"Révolte et Protestation  "}>Révolte et Protestation  </option>
                            <option value={"Nostalgie et Souvenirs "}>Nostalgie et Souvenirs </option>
                            <option value={"Esprit festif et Enthousiasme "}>Esprit festif et Enthousiasme </option>
                            <option value={"Dramatique et Intense "}>Dramatique et Intense</option>
                    ...
                    <textarea 
                      type="text"
                      className="form-control"
                      placeholder="Ex: Votre pensées, plus d'explications, Votre dictionnaire...
                      "
                      rows="12"
                      ref={idea}
